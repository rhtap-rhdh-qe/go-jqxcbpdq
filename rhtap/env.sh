...
export IMAGE_URL=${IMAGE_URL-nexus-docker-nexus.apps.rosa.rhtap-services.xmdt.p3.openshiftapps.com/rhtap/go-jqxcbpdq:$CI_TYPE-$TAG}
...
export ROX_CENTRAL_ENDPOINT="central-tssc-acs.apps.rosa.kx-51ddee03df.0vs1.p3.openshiftapps.com:443"
...
export GITOPS_REPO_URL=https://github.com/rhtap-rhdh-qe/go-jqxcbpdq-gitops
...
export COSIGN_PUBLIC_KEY="LS0tLS1CRUdJTiBQVUJMSUMgS0VZLS0tLS0KTUZrd0V3WUhLb1pJemowQ0FRWUlLb1pJemowREFRY0RRZ0FFVDZhaDU2NzVSOXR6Z3QwelB5ZEtRTXVBaFZRNwovMGtFL2t5RG1rN1pzSFVabVRzSjVqbk1uSjRjTzlMSmhIYVhzTTV0THQrWWRhcFJXcEZTNXlhRVRRPT0KLS0tLS1FTkQgUFVCTElDIEtFWS0tLS0tCg=="
...
export REKOR_HOST=${REKOR_HOST-https://rekor-server-tssc-tas.apps.rosa.kx-51ddee03df.0vs1.p3.openshiftapps.com}
...
export TUF_MIRROR=${TUF_MIRROR-https://tuf-tssc-tas.apps.rosa.kx-51ddee03df.0vs1.p3.openshiftapps.com}
